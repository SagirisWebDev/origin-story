...
/**
 * Tests for the GDPR `customers/redact` webhook handler.
 *
...
import { action } from "./webhooks.customers.redact.tsx";
...
function buildRequest() {
  return new Request(
    "https://example.myshopify.com/webhooks/customers/redact",
    {
      method: "POST",
      body: JSON.stringify({
        shop_id: 954889,
